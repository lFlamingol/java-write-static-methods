...
Complete `hello` y `add` métodos en [src/main/java/com/bytelegend/Challenge.java](https://github.com/ByteLegendQuest/java-write-static-methods/blob/main/src/main/java/com/bytelegend/Challenge.java) . Ejecute el programa, debe obtener resultados:
...
Пожалуйста, завершите `hello` и `add` методы в [src/main/java/com/bytelegend/Challenge.java](https://github.com/ByteLegendQuest/java-write-static-methods/blob/main/src/main/java/com/bytelegend/Challenge.java) . Запустите программу, вы должны получить результат:
